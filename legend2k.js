...
**
『_id / معلومات عن حسابك』
『_embed / يكرر كلامك بمبيد』
『_roles / يعرض لك الرتب و عددها』
『_server / معلومات عن السيرفر』
『_animal / يعطيك صور حيوانات』
『_image / يعرض صوره السيرفر』
『_avatar / يعرض صورتك او صوره شخص』
『_dt / يعرض الوقت في الامارات و مكه المكرمه و مصر و التاريخ』
『_level / لمعرفة لفلك』
『_points / لمعرفة نقاطك』
『_tag / لزخرفة الكلمات او الجمل بشكل حلو』
**
        ***__🤖 اوامر البوت__***
**
『_ping / يعرض لك سرعه اتصال البوت』
『_uptime / يعرض لك صار للبوت كم شغال』
『_support / سيرفر الدعم القني و المساعده』
『_invite / اضافه البوت』
『_members / حاله الاعضاء』
『_infobot / معلومات عن البوت』
**   
...
『_لعبه صراحه / صراحه』
『_لعبه خواطر / خواطر』
『_يعطيك شعر عن الحب / حب』
『_يخيرك بين شي وشي / لو خيروك』
『_يعطيك عقاب و لازم تنفذه / عقاب』
『_لعبه اسئله / كت تويت』
**
`)
...
message.channel.sendEmbed(cat);
   ...
   client.on('message', message => {
   if (message.content.startsWith("_صراحة")) {
     if(!message.channel.guild) return message.reply('** This command only for servers **');
...
const Sra7a = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("_عقاب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
...
const Za7f = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("_كت تويت")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
 ...
 client.on('message', message => {
   if (message.content.startsWith("_حب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`MAFIA Bot- Script By : legend`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : legend ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(` Prefix _help رمضان كريم`,"http://twitch.tv/King")
...
const secreT = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("_خواطر")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
